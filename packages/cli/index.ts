...
program.command("generate <template>").description("generate a testcase").action(generateTestCase)
program.option("-n, --num [num]",'number of testcases').option("-e, --extension [extension]","file extension");
